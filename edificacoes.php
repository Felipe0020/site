...
<head>
  ...
  <title>Curso Técnico em Edificações</title>
...
<body>
  ...
  <div class="container mt-5">
    <div class="text-center mb-4">
      <h1 class="display-5 fw-bold text-primary">Curso Técnico em Edificações</h1>
      ...
      <div class="tab-content mt-3" id="myTabsContent">
        ...
        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
          <div class="card col-12 col-md-4">
            <a href="EDIFICACOES.pdf" target="_blank">
              <div class="card-body text-center">
                <iframe src="EDIFICACOES.pdf" class="MostrarPdf" width="100%"></iframe>
