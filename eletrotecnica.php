...
<head>
  ...
  <title>Curso Técnico em Eletrotécnica</title>
...
<body>
  ...
  <div class="container mt-5">
    <div class="text-center mb-4">
      <h1 class="display-5 fw-bold text-success">Curso Técnico em Eletrotécnica</h1>
      <p class="lead">Prepare-se para projetar, instalar e manter sistemas elétricos com segurança e eficiência.</p>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 text-center">
        <img src="eletrotecnica.jpg" alt="Curso Técnico em Eletrotécnica" class="img-fluid rounded shadow">
      </div>
    </div>
      ...
      <div class="tab-content mt-3" id="myTabsContent">
        ...
        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
            ...
            <div class="card col-12 col-md-4">
              <a href="documentos/ELETROTECNICA.pdf" target="_blank">
                <div class="card-body text-center">
                  <iframe src="documentos/ELETROTECNICA.pdf" class="MostrarPdf" width="100%"></iframe>
        ...
        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
          ...
          <div class="card col-12 col-md-4">
            <a href="documentos/eletrotecnica1.pdf" target="_blank">
              <div class="card-body text-center">
                <iframe src="documentos/eletrotecnica1.pdf" class="MostrarPdf" width="100%"></iframe>
                <button type="button" class="btn btn-success">Abrir
                  Documento</button>
              </div>
            </a>
