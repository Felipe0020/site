...
<body>
  ...
  <div class="container mt-5">
    <div class="text-center mb-4">
      <h1 class="display-5 fw-bold text-primary">Curso Técnico em Desenvolvimento de Sistemas</h1>
    ...
    <div class="row">
      ...
      <div class="col-md-6 text-center">
        <img src="sistemas.jpg" alt="Curso Técnico em Desenvolvimento de Sistemas" class="img-fluid rounded shadow">
      </div>
    </div>
